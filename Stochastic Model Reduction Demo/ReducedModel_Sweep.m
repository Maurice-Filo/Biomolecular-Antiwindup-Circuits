...
StoichiometryMatrix = StoichiometryMatrix_GeneExp_ReducedAIF();
PropensityFunction = @PropensityFunction_GeneExp_ReducedAIF;
Parameters = Parameters_GeneExp_ReducedAIF();
...
%% Save data
Save_Flag = 1;
FileName = fullfile(DataPath, 'ReducedModel');
if Save_Flag == 1
    clear euler pool
    save(FileName);
end