    ...
    Handle_Axis1.Box = 'on';
 	...
 	grid(Handle_Axis1, 'on');
  	...
  	Handle_Axis1.YMinorGrid = 'on';
   	Handle_Axis1.Title.String = 'Disturbance Rejection: Anti-Windup Topology II';
...
if Save_Flag == 1  
    ...
    print(Handle_Figure1, 'AW2_Saturation_Rejection', '-dpdf', '-painters');
    Handle_Figure1.Color = [1, 1, 1];
    
    Handle_Figure2.Color = 'none';
    set(Handle_Figure2, 'InvertHardCopy', 'off');
    print(Handle_Figure2, 'AW2_Saturation_Rejection_Disturbance', '-dpdf', '-painters');
    Handle_Figure2.Color = [1, 1, 1];
end
