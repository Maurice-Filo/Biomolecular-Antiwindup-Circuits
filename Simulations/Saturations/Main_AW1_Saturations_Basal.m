...
StoichiometryMatrix_Controller = StoichiometryMatrix_AW1();
PropensityFunction_Controller = @PropensityFunction_AW1;
% Parameters
Parameters_Controller.mu = 5;
...
Parameters_Controller.WindupParameters.beta_1 = 2;
Parameters_Controller.WindupParameters.beta_2 = 20;
Parameters_Controller.h_1 = @(z_2, Parameters) (Parameters.alpha_1 * max(z_2 - Parameters.beta_1, 0));
Parameters_Controller.h_2 = @(z_1, Parameters) (Parameters.alpha_2 * max(z_1 - Parameters.beta_2, 0));

%% Reduced Controller
% Controller Selection
StoichiometryMatrix_Controller_Reduced = StoichiometryMatrix_AW1_Reduced();
PropensityFunction_Controller_Reduced = @PropensityFunction_AW1_Reduced; 
    ...
    Handle_Axis1.Box = 'on';
 	...
 	grid(Handle_Axis1, 'on');
  	...
  	Handle_Axis1.YMinorGrid = 'on';
   	Handle_Axis1.Title.String = 'Disturbance Rejection: Anti-Windup Topology I';
...
Handle_Axis2.YLim = [0*min([Parameters_Plant.(DisturbedParameter), Parameters_Plant.(DisturbedParameter) * DisturbanceFactor_1, Parameters_Plant.(DisturbedParameter) * DisturbanceFactor_1 * DisturbanceFactor_2, Parameters_Plant.(DisturbedParameter) * DisturbanceFactor_1 * DisturbanceFactor_2 * DisturbanceFactor_3, Parameters_Plant.(DisturbedParameter) * DisturbanceFactor_1 * DisturbanceFactor_2 * DisturbanceFactor_3]), ...
                     1.5*max([Parameters_Plant.(DisturbedParameter), Parameters_Plant.(DisturbedParameter) * DisturbanceFactor_1, Parameters_Plant.(DisturbedParameter) * DisturbanceFactor_1 * DisturbanceFactor_2, Parameters_Plant.(DisturbedParameter) * DisturbanceFactor_1 * DisturbanceFactor_2 * DisturbanceFactor_3, Parameters_Plant.(DisturbedParameter) * DisturbanceFactor_1 * DisturbanceFactor_2 * DisturbanceFactor_3])];
...
if Save_Flag == 1  
    ...
    print(Handle_Figure1, 'AW1_Saturation_Rejection', '-dpdf', '-painters');
    Handle_Figure1.Color = [1, 1, 1];
    
    Handle_Figure2.Color = 'none';
    set(Handle_Figure2, 'InvertHardCopy', 'off');
    print(Handle_Figure2, 'AW1_Saturation_Rejection_Disturbance', '-dpdf', '-painters');
    Handle_Figure2.Color = [1, 1, 1];
end
