...
% Anti-Windup
Parameters_Controller.WindupParameters.alpha_1 = 0;
Parameters_Controller.WindupParameters.alpha_2 = 0.1;
Parameters_Controller.WindupParameters.beta_1 = 0;
Parameters_Controller.WindupParameters.beta_2 = 1;
...
t_Disturbance_1 = 50;
DisturbanceFactor_2 = 1; %23/27;
t_Disturbance_2 = 120;
DisturbanceFactor_3 = 1; %9/16;
t_Disturbance_3 = 300;
DisturbanceFactor_4 = 1; %16/9;
t_Disturbance_4 = 375;
...
%    	Handle_Axis1.Title.String = 'Integral Windup -- Negative Equilibrium & Saturations';
...
if Save_Flag == 1  
    ...
    print(Handle_Figure1, 'AW1_Saturation_Tracking', '-dpdf', '-painters');
    Handle_Figure1.Color = [1, 1, 1];
    
    Handle_Figure2.Color = 'none';
    set(Handle_Figure2, 'InvertHardCopy', 'off');
    print(Handle_Figure2, 'AW1_Saturation_Tracking_Input', '-dpdf', '-painters');
    Handle_Figure2.Color = [1, 1, 1];
end
