...
StoichiometryMatrix_Controller = StoichiometryMatrix_PID3_AW3_Realization();
PropensityFunction_Controller = @PropensityFunction_PID3_AW3_Realization;
% Parameters
...
Parameters_Controller.kappa_v = 10;
Parameters_Controller.kappa_w = 10;
...
Parameters_Controller_NoAW.h_1 = @(v_1, v_2) 1;
Parameters_Controller_NoAW.h_2 = @(w_1, w_2) 1;
...
Handle_Axis11 = axes(Handle_Figure1);
    ...
    Handle_Axis11.Title.Position(1:2) = [1.1e4, 105];
plot(Handle_Axis11, t_AW, X_AW(L+4,:), 'Color', Colors(5,:), 'LineWidth', LineWidth);
...
if Save_Flag == 1  
    ...
    print(Handle_Figure1, 'PID3_RealizedAW3_Saturation_Rejection', '-dpdf', '-painters');
    Handle_Figure1.Color = [1, 1, 1];
    
    Handle_Figure2.Color = 'none';
    set(Handle_Figure2, 'InvertHardCopy', 'off');
    print(Handle_Figure2, 'PID3_RealizedAW3_Saturation_Rejection_Disturbance1', '-dpdf', '-painters');
    Handle_Figure2.Color = [1, 1, 1];
end
