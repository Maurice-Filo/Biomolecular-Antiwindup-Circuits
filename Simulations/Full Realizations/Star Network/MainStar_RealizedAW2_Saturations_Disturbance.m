...
StoichiometryMatrix_Controller = StoichiometryMatrix_PID3_AW2_Realization();
PropensityFunction_Controller = @PropensityFunction_PID3_AW2_Realization;
% Parameters
...
% Anti-Windup
Parameters_Controller.eta_v = 1e6;
Parameters_Controller.eta_w = 1e6;
...
Handle_Axis11 = axes(Handle_Figure1);
    ...
    Handle_Axis11.Title.Position(1:2) = [1.1e4, 2.8e-3];
...
if Save_Flag == 1  
    ...
    print(Handle_Figure1, 'PID3_RealizedAW2_Saturation_Rejection', '-dpdf', '-painters');
    Handle_Figure1.Color = [1, 1, 1];
    
    Handle_Figure2.Color = 'none';
    set(Handle_Figure2, 'InvertHardCopy', 'off');
    print(Handle_Figure2, 'PID3_RealizedAW2_Saturation_Rejection_Disturbance1', '-dpdf', '-painters');
    Handle_Figure2.Color = [1, 1, 1];
end
