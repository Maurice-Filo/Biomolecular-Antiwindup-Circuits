...
Parameters_Controller.kappa_v = 5;
Parameters_Controller.kappa_w = 5;
...
Handle_Axis11 = axes(Handle_Figure1);
    ...
    Handle_Axis11.Title.Position(1:2) = [250, 2.4];
...
% end
% Handle_Axis3(1).Title.String = 'Topology III: Anti-Windup Species';
...
if Save_Flag == 1  
    ...
    print(Handle_Figure1, 'RealizedAW3_Saturation_Tracking', '-dpdf', '-painters');
    Handle_Figure1.Color = [1, 1, 1];
    
    Handle_Figure2.Color = 'none';
    set(Handle_Figure2, 'InvertHardCopy', 'off');
    print(Handle_Figure2, 'RealizedAW3_Saturation_Tracking_Input', '-dpdf', '-painters');
    Handle_Figure2.Color = [1, 1, 1];
    
    % Handle_Figure3.Color = 'none';
    % set(Handle_Figure3, 'InvertHardCopy', 'off');
    % print(Handle_Figure3, 'RealizedAW3_Saturation_Tracking_AWVariables', '-dpdf', '-painters');
    % Handle_Figure3.Color = [1, 1, 1];
end
