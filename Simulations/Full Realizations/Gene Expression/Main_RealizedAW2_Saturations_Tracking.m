...
Handle_Axis11 = axes(Handle_Figure1);
    ...
    Handle_Axis11.Title.Position(1:2) = [250, .4];
...
if Save_Flag == 1  
    ...
    print(Handle_Figure1, 'RealizedAW2_Saturation_Tracking', '-dpdf', '-painters');
    Handle_Figure1.Color = [1, 1, 1];
    
    Handle_Figure2.Color = 'none';
    set(Handle_Figure2, 'InvertHardCopy', 'off');
    print(Handle_Figure2, 'RealizedAW2_Saturation_Tracking_Input', '-dpdf', '-painters');
    Handle_Figure2.Color = [1, 1, 1];
    
    % Handle_Figure3.Color = 'none';
    % set(Handle_Figure3, 'InvertHardCopy', 'off');
    % print(Handle_Figure3, 'RealizedAW2_Saturation_Tracking_AWVariables', '-dpdf', '-painters');
    % Handle_Figure3.Color = [1, 1, 1];
end
