...
Parameters_Controller.alpha_v = 0.1;
Parameters_Controller.alpha_w = 0.1;
...
if Save_Flag == 1  
    ...
    print(Handle_Figure1, 'Sweep_eta_AW2_2', '-dpdf', '-painters');
    Handle_Figure1.Color = [1, 1, 1];
    
    Handle_Figure2.Color = 'none';
    set(Handle_Figure2, 'InvertHardCopy', 'off');
    print(Handle_Figure2, 'Sweep_eta_AW2_Disturbance_2', '-dpdf', '-painters');
    Handle_Figure2.Color = [1, 1, 1];
