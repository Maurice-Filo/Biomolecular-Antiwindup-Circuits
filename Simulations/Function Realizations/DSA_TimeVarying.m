function [time_vector, x] = DSA_TimeVarying(StoichiometryMatrix, PropensityFunction, NetworkParameters, x0, tf, N, Solver)
...
function dx = RHS(t, x, StoichiometryMatrix, PropensityFunction, NetworkParameters)
    dx = StoichiometryMatrix * PropensityFunction(x, NetworkParameters, t);
end