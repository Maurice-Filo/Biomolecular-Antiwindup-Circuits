...
addparameter(m1, 'b_1', b_1, 'Units', '1/((picomole) * hour)');
addparameter(m1, 'b_2', b_2, 'Units', '1/((picomole) * hour)');
...
Reaction = addreaction(m1, 'Controller.Z_1 -> null');
Reaction.ReactionRate = 'b_1 * Controller.V_2 * Controller.Z_1';
...
Reaction = addreaction(m1, 'Controller.Z_2 -> null');
Reaction.ReactionRate = 'b_2 * Controller.W_2 * Controller.Z_2';
...
if Save_Flag == 1
    ...
    print(Handle_Figure1, 'Diabetes_Control_AW2', '-dpdf', '-painters');
    Handle_Figure1.Color = [1, 1, 1];
    
    Handle_Figure2.Color = 'none';
    set(Handle_Figure2, 'InvertHardCopy', 'off');
    print(Handle_Figure2, 'Diabetes_Response_AW2', '-dpdf', '-painters');
    Handle_Figure2.Color = [1, 1, 1];
end
