...
%% Load Model
addpath('/Applications/MATLAB_R2023b.app/toolbox/simbio/simbio/');
...
addparameter(m1, 'b_1', b_1, 'Units', '1/hour');
addparameter(m1, 'b_2', b_2, 'Units', '1/hour');
...
Reaction.ReactionRate = 'a_1 * Controller.Z_2';
...
Reaction = addreaction(m1, 'null -> Controller.Z_2');
Reaction.ReactionRate = 'b_2 * Controller.W_2';

%% AIF Control
% Simulation
DiabeticType1Sim_AW = sbiosimulate(m1, configset, [], mealDose);
param1 = sbioselect(m1, 'Type', 'parameter', 'Name', 'b_1');
param2 = sbioselect(m1, 'Type', 'parameter', 'Name', 'b_2');
param1.Value = 0;
param2.Value = 0;
...
if Save_Flag == 1
    ...
    print(Handle_Figure1, 'Diabetes_Control_AW1', '-dpdf', '-painters');
    Handle_Figure1.Color = [1, 1, 1];
    
    Handle_Figure2.Color = 'none';
    set(Handle_Figure2, 'InvertHardCopy', 'off');
    print(Handle_Figure2, 'Diabetes_Response_AW1', '-dpdf', '-painters');
    Handle_Figure2.Color = [1, 1, 1];
end
