function Propensity = PropensityFunction_AW1(z, y, Parameters)
% Propensity Function for Anti Windup Topology 1
% 	 Species:           X = [Z_1; Z_2]
...
Propensity = [  Parameters.ActuationFunction(z(1), Parameters.ActuationParameters); ...
                mu + Parameters.h_1(z(2), Parameters.WindupParameters); ...
                Parameters.SensingFunction(y, Parameters.SensingParameters) + Parameters.h_2(z(1), Parameters.WindupParameters); ...
                eta * z(1) * z(2); ...
                delta_1 * z(1); ...
                delta_2 * z(2); ...
              ];
